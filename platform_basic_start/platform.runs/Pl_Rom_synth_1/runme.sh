...
HD_PWD='C:/Users/Dima/OneDrive/Documents/ECE4710/project/platform/platform/platform.runs/Pl_Rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pl_Rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pl_Rom.tcl
