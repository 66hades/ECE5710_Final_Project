...
--            --end block calculations
			...
			if (data_in(0)) = '1' then   
                ...
                --archive
--                                if (dcv = "0000000001") and (drv = "0000000001") then --ball moving from left to right, downwards
--                    if ((c1v  + ball_dimension/2 > cpix_block) and (c1v + ball_dimension/2  < cpix_block + block_width)) then
--                        dcv := 0 - dcv;
--                    end if;
                    
--                    if ((r1v  + ball_dimension/2 > rpix_block) and (r1v + ball_dimension/2  < rpix_block + block_height)) then
--                        drv := 0 - drv;
--                    end if;
--                end if;
